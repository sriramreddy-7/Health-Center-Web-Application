...
class PrescribedMedicine(models.Model):
    ...
    date_prescribed = models.DateField(default=now, editable=False)  # Set default value

    def save(self, *args, **kwargs):
        if not self.id:  # Set default value only if object is being created
            self.date_prescribed = now()
        super().save(*args, **kwargs)
